...
| Para el funcionamiento de ROS2 es necesario instalar Ubuntu.
...
- **Imagen ISO Ubuntu 22.04.6:**
  `Descarga Oficial <https://releases.ubuntu.com/22.04/>`__
...
Es necesario utilizar la ISO descargada de Ubuntu 22.04 LTS `Ver en YouTube <https://www.youtube.com/watch?v=_d6oT7rEoGc>`__

- **Opción 2: Máquina Virtual:**  
  :doc:`Guía práctica aquí <maquina_virtual>`
...
SSH permite acceso remoto seguro a otra máquina, útil cuando trabajas con robots o servidores de
manera remota. estructura: 
